...
sed -i 's/Listen 80/Listen 7777/g' /home/techzone/IBM/HTTPServer/conf/httpd.conf
...
AdminApp.install(
    DEMOPATH + '/modresorts-2.0.0.war',
    f'''[
        -distributeApp 
        -useMetaDataFromBinary 
        -appname modresorts-2_0_0_war 
        ...
        -contextroot /resorts 
        -MapModulesToServers [[ 
            modresorts-2.0.0.war modresorts-2.0.0.war,WEB-INF/web.xml 
